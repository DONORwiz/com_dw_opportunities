...
$canOrder	= $user->authorise('core.edit.state', 'com_dw_opportunities');
$saveOrder	= $listOrder == 'a.ordering';
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_dw_opportunities&task=opportunities.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'opportunityList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<?php endif;?>
		...
		<table class="table table-striped" id="opportunityList">
			...
			<?php foreach ($this->items as $i => $item) :
                ...
                <?php if (isset($this->items[0]->state)): ?>
					<td class="center">
						<?php echo JHtml::_('jgrid.published', $item->state, $i, 'opportunities.', $canChange, 'cb'); ?>
					</td>
                <?php endif; ?>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_dw_opportunities&task=opportunity.edit&id='.(int) $item->id); ?>">
